 ...
 * @author Nekopanda
 */
public class BattleExBaseDto extends AbstractDto {
    ...
    public static class Phase {
        ...
        public Phase(BattleExBaseDto battle, JsonObject object, BattlePhaseKind kind,
        ...
        public void battleDamage(BattleExBaseDto battle) {
        ...
        public void practiceDamage(BattleExBaseDto battle) {
            int numFships = this.nowFriendHp.length;
            int numEships = this.nowEnemyHp.length;
            boolean isCombined = (this.nowFriendHpCombined != null);
            int numFshipsCombined = isCombined ? this.nowFriendHpCombined.length : 0;
        ...
        // 勝利判定 //
        private ResultRank calcResultRank(BattleExBaseDto battle) {
            boolean isCombined = (this.nowFriendHpCombined != null);
            int numFships = this.nowFriendHp.length;
            int numFshipsCombined = isCombined ? this.nowFriendHpCombined.length : 0;
            int numEships = this.nowEnemyHp.length;
         ...
         * @return
         */
        public String getRankCalcInfo(BattleExBaseDto battle) {
            boolean isCombined = (this.nowFriendHpCombined != null);
            int numFships = this.nowFriendHp.length;
            int numFshipsCombined = isCombined ? this.nowFriendHpCombined.length : 0;
            int numEships = this.nowEnemyHp.length;
     ...
     * @param date 戦闘のあった日時
     */
    public BattleExBaseDto(Date date) {
