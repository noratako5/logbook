...
/***/ function(module, exports, __webpack_require__) {
	...
	var HougekiTable_1 = __webpack_require__(1);
	(function () {
	    ...
	    this.header = function header() {
	        return HougekiTable_1["default"].header();
	    };
	    this.body = function body(battleExDto) {
	        return HougekiTable_1["default"].body(battleExDto);
	    };
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HougekiRow_1 = __webpack_require__(2);
	var PhaseStatus_1 = __webpack_require__(11);
	var toComparable_1 = __webpack_require__(13);
	var HougekiTable = (function () {
	    function HougekiTable() {
	    }
	    HougekiTable.header = function () {
	        return HougekiRow_1["default"].header();
	    };
	            ...
	            if (phaseKindDto != null) {
	                if (!phaseKindDto.isNight()) {
	                    ...
	                    if (phaseJson != null) {
	                        ...
	                        if (phaseApi != null) {
	                            var phaseStatus = new PhaseStatus_1["default"](battleExDto, phaseDto);
	                            rows.push.apply(rows, HougekiRow_1["default"].body(battleExDto, phaseStatus, phaseDto, phaseApi, 1));
	                            rows.push.apply(rows, HougekiRow_1["default"].body(battleExDto, phaseStatus, phaseDto, phaseApi, 2));
	                            rows.push.apply(rows, HougekiRow_1["default"].body(battleExDto, phaseStatus, phaseDto, phaseApi, 3));
	                        }
	                    }
	                }
	            }
	        }
	        return toComparable_1["default"](rows);
	    };
	    return HougekiTable;
	})();
	exports.__esModule = true;
	exports["default"] = HougekiTable;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhaseRow_1 = __webpack_require__(6);
	var ShipRow_1 = __webpack_require__(7);
	var Ships_1 = __webpack_require__(9);
	var JavaInteger = Packages.java.lang.Integer;
	var HougekiRow = (function () {
	    function HougekiRow() {
	    }
	    HougekiRow.header = function () {
	        var row = _.clone(PhaseRow_1["default"].header());
	        row.push.apply(row, [
	            '戦闘種別',
	            '自艦隊',
	            '巡目',
	        ...
	        row.push.apply(row, _.map(ShipRow_1["default"].header(), function (s) { return ('攻撃艦.' + s); }));
	        row.push.apply(row, _.map(ShipRow_1["default"].header(), function (s) { return ('防御艦.' + s); }));
	        return row;
	    };
	    HougekiRow.body = function (battleExDto, phaseStatus, phaseDto, phaseApi, hougekiIndex) {
	        ...
	        if (api_hougeki != null) {
	            for (var i = 1; i < api_hougeki.api_at_list.length; ++i) {
	                var ships = new Ships_1["default"](battleExDto, phaseStatus, fleetStatusList[i - 1]);
	                var phaseRow = PhaseRow_1["default"].body(battleExDto, phaseDto, phaseApi, ships.itemInfos);
	                if (isSecond) {
...
/***/ function(module, exports) {
	...
	var PhaseRow = (function () {
	    ...
	    PhaseRow.body = function (battleExDto, phaseDto, phaseApi, itemInfos) {
	        var row = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemRow_1 = __webpack_require__(8);
	var JavaInteger = Packages.java.lang.Integer;
	...
	var ShipRow = (function () {
	    ...
	    ShipRow.header = function () {
	        ...
	        row.push.apply(row, ItemRow_1["default"].header());
	        return row;
	    };
	    ShipRow.body = function (shipBaseDto, hp, maxHp, index) {
	        if (shipBaseDto != null) {
	            ...
	            row.push(luck);
	            row.push(leng);
	            row.push.apply(row, ItemRow_1["default"].body(shipBaseDto));
	            return row;
	        }
	        else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(3);
	var ItemInfos_1 = __webpack_require__(10);
	var ShipRow_1 = __webpack_require__(7);
	var Ships = (function () {
	    function Ships(battleExDto, phaseStatus, fleetsStatus) {
	        var _this = this;
	        this.itemInfos = new ItemInfos_1["default"]();
	    ...
	    Ships.prototype.createShipRow = function (shipBaseDto, hp, maxHp, index) {
	        return ShipRow_1["default"].body(shipBaseDto, hp, maxHp, index);
	    };
	    return Ships;
	})();
	exports.__esModule = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FleetsStatus_1 = __webpack_require__(12);
	var PhaseStatus = (function () {
	    function PhaseStatus(battleExDto, phaseDto) {
	        this.maxFleetsStatus = new FleetsStatus_1["default"](battleExDto.getMaxFriendHp(), battleExDto.getMaxFriendHpCombined(), battleExDto.getMaxEnemyHp());
	        var phase1Dto = battleExDto.getPhase1();
	        var phase2Dto = battleExDto.getPhase2();
	        if (phaseDto === phase1Dto) {
	            var fleetsStatus = new FleetsStatus_1["default"](battleExDto.getStartFriendHp(), battleExDto.getStartFriendHpCombined(), battleExDto.getStartEnemyHp());
	        }
	        else if (phaseDto === phase2Dto) {
	            var fleetsStatus = new FleetsStatus_1["default"](phase1Dto.getNowFriendHp(), phase1Dto.getNowFriendHpCombined(), phase1Dto.getNowEnemyHp());
	        }
